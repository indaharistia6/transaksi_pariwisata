...
import  'package:penjualan/ui/inputpenjualan.dart'; 
import  'package:penjualan/models/penjualan.dart'; 
import  'package:penjualan/helpers/dbhelper.dart';
    ...
    child:  ListTile(
      ...
      subtitle:  Row(
        children:  <Widget>[ 
          ...
          Text("  |  "+this.penjualanList[index].keterangan,  style:  TextStyle(fontWeight:  FontWeight.bold),),
        ],
      ),
